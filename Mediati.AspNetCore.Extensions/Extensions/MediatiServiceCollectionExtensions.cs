...
namespace Mediati.AspNetCore.Extensions
{
    ...
    {
        /// <summary>
        /// Adds default Mediati mediator as a service
        /// </summary>
        /// <param name="services">Service collection to bind to</param>
        public static void AddMediati(this IServiceCollection services)
        {
            services.AddTransient<IMediator, Mediator>();
        }
        
        /// <summary>
        /// Adds all public Mediati handlers in the assembly as services with dependencies
        /// </summary>
        /// <param name="assemblies">Assemblies to scan for handler implementations</param>
        /// <param name="services">Service collection to bind to</param>
        public static void AddMediatiHandlers(this IServiceCollection services, params Assembly[] assemblies)
        {
            // Gather all handlers 
